...
<div class="container">
	...
	<div class="cont">
		...
		<thead>
			<tr>
				<th>Презентация <i class="fa fa-chevron-down" aria-hidden="true"></i><i class="fa fa-chevron-up" aria-hidden="true"></i></th>
				<th>Время создания <i class="fa fa-chevron-down" aria-hidden="true"></i><i class="fa fa-chevron-up" aria-hidden="true"></i></th>
				<th>Размер</th>
				<th>Ссылка</th>
			</tr>
		</thead>
