	...
	<div class="cont">
		...
		<ul class="nav nav-tabs" role="tablist">
		  ...
		  <li class="nav-item">
		   ...
		   <li class="nav-item">
		    <a class="nav-link" data-toggle="tab" href="#pprc" role="tab">Обработка прайсов</a>
		  </li>
		  <li class="nav-item">
		    <a class="nav-link" data-toggle="tab" href="#pout" role="tab">Дополнительные настройки</a>
		  </li>
		  <li class="nav-item">
		...
		<div class="tab-content container">
		  <div class="tab-pane active" id="phome" role="tabpanel">
		  	...
		  	<p><label for="aftLink"><input type="checkbox" name="aftLink" id="aftLink">&nbsp;Проверить на дубли</label></p>
		  ...
		  <div class="tab-pane" id="pgroups" role="tabpanel">
		  	...
		  	<button class="btn btn-success" id="add-group"><i class="fa fa-plus" aria-hidden="true"></i> Добавить презентацию</button>
		  </div>
		  ...
		  <div class="tab-pane" id="pmarks" role="tabpanel">
		  	...
		  	<button class="btn btn-success" id="add-mark"><i class="fa fa-plus" aria-hidden="true"></i> Добавить отметку</button>
		  </div>
		  ...
		  <div class="tab-pane" id="pgrp" role="tabpanel">
		  	...
		  	<button class="btn btn-success" id="add-grp"><i class="fa fa-plus" aria-hidden="true"></i> Добавить группу</button>
		  </div>
		  ...
		  <div class="tab-pane" id="pout" role="tabpanel">
		  	...
		  	<div class="s-set-bl">
				...
				<div class="form-group row">
				  ...
				  <div class="col-9">
				    <select id="s-fontheadername" class="form-control">
				    	...
				    	<option style="font-family: 'Arial Black', Gadget, sans-serif;" value="Arial Black">Arial Black</option>
				    	<option style="font-family: 'Comic Sans MS', cursive;" value="Comic Sans MS">Comic Sans MS</option>
				    	...
				    	<option style="font-family: Verdana, Geneva, sans-serif;" value="Verdana">Verdana</option>
				    </select>
				  </div>
				</div>
				...
				<div class="form-group row">
				  <label for="s-colfosize" class="col-3 col-form-label">Отметка. Размер текста базовая цена</label>
				  <div class="col-9">
		    ...
		    <div class="form-group row">
				...
				<button class="btn btn-success" id="save-settings"><i class="fa fa-save" aria-hidden="true"></i> Сохранить</button>
			</div>
		  	...
		  	<div class="tab-pane" id="pprc" role="tabpanel">
			  	...
			  	<button class="btn btn-default" id="add-link"><i class="fa fa-plus" aria-hidden="true"></i> Добавить файл</button>
			  	<button class="btn btn-success" id="start-link"><i class="fa fa-play" aria-hidden="true"></i> Убрать дубли</button>
		  </div>	
		</div>
	</div>
</div>
